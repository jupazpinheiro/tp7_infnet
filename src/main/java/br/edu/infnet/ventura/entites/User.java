...
public class User {
    ...
    @Column(length=10, name="use_id")
    private int userId;
    @Column(length=100, name="use_name")
    private String userName;
    @Column(length=100, name="use_email")
    private String userEmail;
    @Column(length=100, name="use_password")
    private String userPassword;
    @Column(length=12, name="use_phone")
    private String userPhone;
    @Column(length=1500, name="use_pic")
    private String userPic;
    @Column(length=1500, name="use_address")
